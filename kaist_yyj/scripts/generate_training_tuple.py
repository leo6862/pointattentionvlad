...
# training_seqs = ["urban01","urban02","urban03","urban05","urban06","urban07","urban08",
#                  "urban10","urban11","urban12","urban13","urban15","urban16"]
# testing_seqs = ["urban04","urban09","urban14"]
    ...
    with open(txt_path,'r') as txt_file:#读取 stamp & pose txt
        for line in txt_file:
            ...
            if not check_processed_bin_file_exists(seq,stamp):
                ...
                sys.exit()
            txt_dict[stamp] = [x,y,z,global_id] #生成 stmap -> pose * global_id 
            global_id += 1
...
pickle_file_name = os.path.join(data_root,"training_tuple.pickle")
