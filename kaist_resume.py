...
# import models.yyj_model_4_local_attention as YYJ_model_4_local_attention
...
parser.add_argument('--dataset_folder', default='/root/autodl-tmp/kaist_v3/',
...
def train():
    ...
    resume_filename = cfg.LOG_DIR + "kaist_v3_88.6_recall.ckpt"
