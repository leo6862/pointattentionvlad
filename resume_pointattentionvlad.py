...
parser.add_argument('--dataset_folder', default='/root/autodl-tmp/benchmark_datasets/',
...
def train():
    ...
    resume_filename = cfg.LOG_DIR + "T_2_h_4_90_49_recall.ckpt"
